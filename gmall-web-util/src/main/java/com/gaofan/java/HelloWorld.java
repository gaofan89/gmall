...
//     * 11  如何查看源码 (class) ctrl +  选中指定的结构  或 ctrl + shift + t
     ...
     * 41  查看方法的多层重写结构(method hierarchy)
     * ctrl+alt+h
     * 42
     * 添加到 收藏(add to favorites)  ctrl+alt+f
     * 43
     * 抽取方法(Extract Method)
     * alt+shift+m
     * 44  打开 最近 修改的文件(Recently Files)
     * ctrl+E
     * 45  关闭当前打开的代码栏(close)  ctrl + w
     * 46  关闭打开的所有代码栏(close all) ctrl + shift + w
     * 47  快速搜索类中的错误(next highlighted error)
     * ctrl + shift + q
     * 48  选择要粘贴的内容(Show in Explorer)
     * ctrl+shift+v
